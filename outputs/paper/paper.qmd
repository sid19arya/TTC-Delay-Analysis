...
The data utilized in this paper is from OpenDataToronto Library, the Datasets used are entitled: “TTC-Streetcar-Delays”. The data was collected, sorted and analyzed through the help of … (Cite all the packages).[@citeR] 
